...
//	printf("       TOTAL DOC SIZE %d\n", total_doc_size);
	...
	//bool* output_inh_flags = (bool*)aligned_alloc(4096, total_size*sizeof(bool));
	...
	//cl::Buffer buffer_output_inh_flags(context, CL_MEM_USE_HOST_PTR | CL_MEM_WRITE_ONLY, total_size*sizeof(bool),output_inh_flags);
...
//printf("_Output Received %d -> %d\n", doc, output_inh_flags[n]);
